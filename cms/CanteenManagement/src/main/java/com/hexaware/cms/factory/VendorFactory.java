...
import com.hexaware.cms.persistence.VendorDAO;
...
public class VendorFactory {
   ...
   */
  public static int authenticateVendor(final int vendorId, final String vendorPassword) {
      return dao().authenticateVendor(vendorId, vendorPassword);
  }
  /**
   * Call the data base connection.
