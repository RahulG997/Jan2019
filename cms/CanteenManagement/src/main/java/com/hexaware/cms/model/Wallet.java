 ...
 */
  public Wallet(final int argswalletId, final double argswalletAmount, final WalletSource argswalletSource) {
  ...
  /**
     ...
     */
  public final void setWalletSource(final WalletSource argswalletSource) {
    this.walletSource = argswalletSource;
  }
  /**
